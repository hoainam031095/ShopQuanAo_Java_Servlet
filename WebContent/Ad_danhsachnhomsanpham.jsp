      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="row-header">
            <a href="QuanTriThemNhomSanPhamServlet"><button class="btn btn-primary" style="width: 90px;">Thêm mới</button></a>
          </div>
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                %>
                  <tr>
                    <td><%=i%></td>
                    <td class="col-md-1 col-sm-1"><a href="#"><%=nsp.getMaNhomSP()%></a></td>
                    <td class="col-md-3 col-sm-3" ><%=nsp.getTenNhomSP()%></td>
                    <td class="col-md-7 col-sm-7"><%=nsp.getContent()%></td>
                    <td class="col-md-1 col-sm-1" style="text-align: center;">
                      <a href="QuanTriSuaNhomSanPhamServlet?maNhomSP=<%=nsp.getMaNhomSP()%>" style="padding: 0px 5px; font-size: 16px;"> <i class="fa fa-pencil"></i></a>
                      <a href="QuanTriXoaNhomSanPhamServlet?maNhomSP=<%=nsp.getMaNhomSP()%>" style="padding: 0px 5px; font-size: 17px; color: red;"><i class="fa fa-trash-o"></i></a>
                    </td>
                  </tr>
                  <%
                  i++;
