						...
						<div class="box">
							...
							<div class="box-body">
								<table id="example2" class="table table-bordered table-hover">
									...
									<tbody>
									<% ArrayList<KhachHang> listKH = (ArrayList<KhachHang>)request.getAttribute("listKH");
									int i = 1;
									for(KhachHang kh: listKH){%>
										<tr>
											<td><%=i%></td>
											<td class="col-md-1 col-sm-1"><%=kh.getMaKhachHang() %></td>
											<td class="col-md-2 col-sm-2"><%=kh.getTenKhachHang() %></td>
											<td class="col-md-4 col-sm-4"><%=kh.getDiaChi() %></td>
											<td class="col-md-1 col-sm-1"><%=kh.getSoDienThoai() %></td>
											<td class="col-md-3 col-sm-3"><%=kh.getEmail()%></td>
											<td class="col-md-1 col-sm-1" style="text-align: center;">
												<a href="QuanTriSuaKhachHangServlet?maKH=<%=kh.getMaKhachHang() %>" style="padding: 0px 5px; font-size: 16px;">
													<i class="fa fa-pencil"></i>
											</a> <a href="QuanTriXoaKhachHangServlet?maKH=<%=kh.getMaKhachHang() %>"
