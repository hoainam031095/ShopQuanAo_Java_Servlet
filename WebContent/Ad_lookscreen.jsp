...
<div class="lockscreen-wrapper">
  ...
  <!-- User name -->
  <div class="lockscreen-name">Anonymous</div>

  <!-- START LOCK SCREEN ITEM -->
  <div class="lockscreen-item">
    <!-- lockscreen image -->
    <div class="lockscreen-image">
      <img src="Ad_dist/img/user1-128x128.jpg" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
  ...
  <div class="help-block text-center">
    Enter key to continue using software!
  </div>
  <div class="text-center">
    <a href="https://www.facebook.com/nano.ng.549">Get key</a>
  </div>
  <div class="lockscreen-footer text-center">
    Copyright &copy; by <b><a href="https://www.facebook.com/nano.ng.549" class="text-black">KenIT</a></b><br>
    All rights reserved
  </div>
</div>
<!-- /.center -->
