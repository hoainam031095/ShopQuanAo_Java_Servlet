...
<div class="tygh-content clearfix">
					<% Menu menu = (Menu)request.getAttribute("menu");
						NhomSanPham nhomSP = (NhomSanPham)request.getAttribute("nhomSP");%>
                            ...
                            <div class="span16 breadcrumbs-grid">
                                <div id="breadcrumbs_10">
                                    <div class="ty-breadcrumbs clearfix">
                                        ...
                                        <span class="ty-breadcrumbs__slash">/</span>
                                        <span class="ty-breadcrumbs__current"><%=nhomSP.getTenNhomSP()%></span>
                                    </div>
                                    <!--breadcrumbs_10--></div>
                                </div>
                            </div>
                                        ...
                                        <div class="ty-mainbox-body">
                                            <div id="category_products_11">
                                                    ...
                                                    <p>
                                                        <strong>
                                                            <span id="docs-internal-guid-383c5946-1b5e-5f1b-7e7e-32b06f594771">
                                                                <span style="font-size: 11pt; font-family: Arial; color: rgb(67, 67, 67); background-color: transparent; vertical-align: baseline; white-space: pre-wrap;"><%=nhomSP.getContent()%></span>
                                                            </span>
                                                        </strong>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="ty-pagination-container cm-pagination-container" id="pagination_contents">
                                                	...
                                                	<% String tenNhomSP = nhomSP.getTenNhomSP().toUpperCase(); %>
	                                                <div class="ty-wysiwyg-content ty-mb-s"><strong><%=tenNhomSP%> THỜI TRANG ĐẸP, GIÁ RẺ TẠI TP.HCM.</strong> 
	                                                  <% int k = 0;
	                                                        for(SanPham sp: listSP){
	                                                        	if(k<8){%>
					                                                  <div style="text-align:justify;"> 
					                                                        	<%= sp.getChiTietSanPham()%> 
					                                                  </div>
	                                                  			<%}k++;
	                                                  		} %>
	                                               	 </div>
                                                                ...
                                                                <div class="ty-product-filters__wrapper">
                                                                    ...
                                                                    <% String maxGia = (String)request.getAttribute("maxGia"); %>
                                                                        ...
                                                                        <div id="content_29_1" class="cm-product-filters-checkbox-container ty-price-slider">
                                                                        	<input type="hidden" class="maNhom" id="maLoc" value="<%=nhomSP.getMaNhomSP()%>">
