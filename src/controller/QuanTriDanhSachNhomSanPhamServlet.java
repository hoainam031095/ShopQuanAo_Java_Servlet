...
/**
 * Servlet implementation class QuanTriDanhSachNhomSanPhamServlet
 */
public class QuanTriDanhSachNhomSanPhamServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuanTriDanhSachNhomSanPhamServlet() {
        super();
