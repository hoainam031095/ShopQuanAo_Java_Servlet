...
/**
 * Servlet implementation class NguoiDungLayDanhSachSanPhamTheoGiaVaNhomServlet
 */
public class NguoiDungLayDanhSachSanPhamTheoGiaVaNhomServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NguoiDungLayDanhSachSanPhamTheoGiaVaNhomServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String maNhom = request.getParameter("maLoc");
		String doTuoi = "";
		...
		ArrayList<SanPham> listSP = sanphambo.locDanhSachSanPhamTheogiaVaNhom(maNhom, doTuoi, giaMin, giaMax);
		String responseText = "";
		if(listSP.isEmpty())
