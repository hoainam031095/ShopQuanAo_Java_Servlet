...
/**
 * Servlet implementation class QuanTriXoaSanPhamServlet
 */
public class QuanTriXoaSanPhamServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuanTriXoaSanPhamServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		bo.xoaSanPhamTheoMa(maSanPham);
		
		ArrayList<SanPham> listSP = bo.layDanhSachSanPham();
		request.setAttribute("thongbao", "Xóa thành công sản phẩm");
